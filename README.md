...
<p>Les indices sont directs et factuels, aidant le joueur à se familiariser avec le fonctionnement du jeu. Un ou deux indices devraient mener directement à la réponse.</p>

<h2>Niveau 1 : Intermédiaire</h2>
<p>Ce niveau aide le joueur à pratiquer la création, le déplacement et la copie de fichiers en utilisant des commandes comme <code>mkdir</code>, <code>mv</code>, <code>cp</code> et <code>grep</code>.</p>
<p>Les indices sont un peu moins évidents et demandent plus de réflexion, encourageant le joueur à explorer et combiner différentes commandes pour trouver la solution.</p>
